...
const wildlifeImages = document.querySelectorAll(".wildlife-img");

let currentIndex = 0;

setInterval(() => {
  wildlifeImages[currentIndex].classList.remove("active");

  currentIndex = (currentIndex + 1) % wildlifeImages.length;

  wildlifeImages[currentIndex].classList.add("active");
}, 6000); // 6 sec